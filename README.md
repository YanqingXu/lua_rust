...
| [Phase 3: VM](docs/rust_migration/phase_3_report.md) | 🟡 partial | 主要 dispatch、调用、闭包、metamethod、coroutine 与 managed active Proto 路径存在；coroutine trampoline、Upvalue owner、全量 trace parity 和 host ABI 未完成。 |
